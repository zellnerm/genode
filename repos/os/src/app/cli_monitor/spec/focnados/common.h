...
#ifndef _APP__CLI_MONITOR__SPEC__FOCNADOS__COMMON_H_
#define _APP__CLI_MONITOR__SPEC__FOCNADOS__COMMON_H_
...
#endif /* _APP__CLI_MONITOR__SPEC__FOCNADOS__COMMON_H_ */
