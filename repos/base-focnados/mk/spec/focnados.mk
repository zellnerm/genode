...
-include $(call select_from_repositories,etc/focnados.conf)
-include $(BUILD_BASE_DIR)/etc/focnados.conf
...
#
# L4 build directory, if not defined by 'focnados.conf', use directory local
